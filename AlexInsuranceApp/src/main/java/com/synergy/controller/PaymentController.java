...
import com.stripe.param.PaymentMethodCreateParams.*;
import com.synergy.config.StripeConfig;
import com.synergy.domain.Address;
import com.synergy.domain.PaymentData;
import com.synergy.service.PaymentDataService;
...
public class PaymentController {
    ...
    public ResponseEntity<PaymentData> processPayment(@RequestBody PaymentData paymentData) throws StripeException {
        ...
        CustomerCreateParams customerParams = CustomerCreateParams.builder().setEmail(paymentData.getBillingAddress().getEmail())
