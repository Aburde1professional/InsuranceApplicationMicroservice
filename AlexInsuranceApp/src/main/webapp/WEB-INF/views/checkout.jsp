...
<head>
    ...
    <script src="http://localhost:8282/js/checkout.js"></script>
    <!-- Include Stripe.js library -->
    <script src="https://js.stripe.com/v3/"></script>

    <!-- Include your Stripe publishable key -->
    <script>
        var stripe = Stripe('pk_test_51NGniWF75olEChOCj6MJVKbdeWFYFsw1VjkybygKL7ZIXYWrZdkYyneDo0hCW9EJCI6JitXXI0eyV1FACvOaH9iZ00WoNML1Zm');
    </script>
